...
- Tendency of having longer working period [@Hidrobo2020]

## Educational Level {.smaller}

- Depressive disorder is less prevalent in well-educated subjects [@Lee2015]
- Subjects with lower education levels tends to have worse disease
  comprehension [@Chen2019]
- Education determines depression or anxiety risk [@Luo2019]
- Lower educational status corresponds to elevated depressive symptoms [@Schlax2019]
...
- Suicide rate among elderly rises after SARS pandemic in Hongkong [@Cheung2008]
- COVID-19-infected older adults complaint increased distress [@Lima2020]
...
- Referring to Maslow's hierarchy of needs, younger and productive subjects
  perceive more distress [@Ryan2020]
- Erik Erikson: quarantine as burdensome distress [@Johal2009]
