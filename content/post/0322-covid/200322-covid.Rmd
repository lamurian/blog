...
random event, where population spatial movement depicted either as permutation
or Brownian motion. In this simulation, I wish to use network modelling as a
layer of abstraction in explaining population movement and COVID-19 growth
...
GitHub repository) concatenated widely-available WHO data dated from 21 January
to 5 March 2020. On the first visual inspection, data seems to have missing value due to
temporal differences in first outbreak onset. Only data from China and global
country besides China (referred as "Outside" from this point onward) being
considered on initial data exploration.
