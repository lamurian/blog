...
Please press following buttons to access included features:

- `p` to view the hidden note
- `f` to view the slide in full screen
- `h` to access the help page
- `up` and `left` to access the previous slide
- `down` and `right` to access the next slide
...
class: right, bottom, inverse, animated, slideInRight
...
???
- More than half published investigations **are not replicable**
