...
particular type of chilli pepper still belongs to nominal and ordinal data,
respectively. But we shall see that the count is a discrete numeric data. So,
in essence, discrete data is the result of frequency counting. In other words,
